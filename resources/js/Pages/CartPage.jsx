...
const perfumes = [
    {
        ...
        price: 120,
        discountPrice: 99,
        image: '/images/perfume-image/gallery-ratio-only/versace-eros-flame.png',
        description: 'Citrus – Spicy – Woody'
    },
    {
        id: 2,
        name: 'Armaf Club de Nuit Intense Man',
        category: 'Affordable / Clone',
        price: 45,
        image: '/images/perfume-image/gallery-ratio-only/armaf-club-de-nuit-intense-man.png',
        description: 'Fruity – Smoky – Masculine'
    },
    {
        id: 3,
        name: 'Lattafa Asad',
        ...
        price: 40,
        discountPrice: 32,
        image: '/images/perfume-image/gallery-ratio-only/lattafa-asad.png',
        description: 'Spicy – Ambery – Woody'
    },
];
                        ...
                        <div className="gallery-items grid-cols grid-cols--wrap">
                            {perfumes.map((item) => (
                                <div key={item.id} className="gallery-items__item grid-cols__column">
                                    ...
                                    {/* IMAGE */}
                                    <a href={item.image} className="gallery-items__item-thumb glightbox">
                                        <img src={item.image} alt={item.name} />
                                    </a>

                                    {/* CARD INFO */}
                                    <div className="mt-4 border border-white/20 rounded-lg p-4 bg-black/40">

                                        {/* CATEGORY TAG */}
                                        <span className="inline-block text-[12px] mb-2 text-xs px-3 py-1 rounded-full border border-white/30 text-white/80">
                                            {item.category}
                                        </span>
                                        ...
                                        <div className="mt-3 flex items-center justify-between">
                                            ...
                                            {/* BUTTON */}
                                            <button className="px-4 py-2 text-sm border border-white/40 rounded-md hover:bg-white hover:text-black transition">
                                                + Add to Cart
                                            </button>
                                        </div>
